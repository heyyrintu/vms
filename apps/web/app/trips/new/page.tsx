...
export default function NewTripPage() {
  ...
  const freight = Number(form.vendor_freight_rate || 0); const unloading = Number(form.unloading || 0); const advance = freight * Number(form.advance_percent || 0) / 100; const tds = advance * tdsRate / 100; const gross = advance + unloading;
