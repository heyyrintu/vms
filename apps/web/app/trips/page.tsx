...
export default function TripRegisterPage() {
  ...
  const pageSize = 25;
  const choices = useQuery({ queryKey: ["choices"], queryFn: () => api<{ trip_status: Array<{ value: string; label: string }> }>("/choices/"), staleTime: Infinity });
