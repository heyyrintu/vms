...
# Meta caps AUTHENTICATION-template body parameters at 15 characters, and this
# label is sent as one of them, so keep the default within the limit.
OTP_APP_LABEL = os.getenv("OTP_APP_LABEL", "Drona Logitech")
